...
The packages in the `simple_term_menu_vendor` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy simple_term_menu_vendor --override-release-repository-push-url git@github.com:revyos-ros/simple_term_menu_vendor-release.git` on `Thu, 19 Dec 2024 08:18:08 -0000`
...
- release repository: https://github.com/revyos-ros/simple_term_menu_vendor-release.git
